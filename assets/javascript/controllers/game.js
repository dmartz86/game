(function (ng) {
  ng.controller('GameCtr', ['$scope', '$rootScope', '$http', '$interval', '$timeout', GameCtr]);
  
  function GameCtr($scope, $rootScope, $http, $interval, $timeout) {
    ...
    $scope.codeToS = codeToS;
    $scope.act = act;
    
    function codeToS(code) {
    ...
    $scope.revealIcons = revealIcons
    function revealIcons(challenge) {
      $scope.icons = printIcons(challenge.start, challenge.end);
    }
  
    $scope.removelIcons = removelIcons;
    function removelIcons() {
      $scope.icons = [];
    }
  
    $scope.setChallenge = setChallenge;
